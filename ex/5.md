...
Ahora que ya estas familiarizado con las animaciones en A-Frame y sus propiedades, es hora del primer reto: Realiza la misma animación de este ejercicio pero esta vez no utilices `<a-animation>`, sino el componente de animación. Revisa la [documentación](https://github.com/ngokevin/kframe/tree/master/components/animation) para ver los atributos y propiedades que debes configurar para lograr la animación.
