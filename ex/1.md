...
1. Lo primero que hicimos fue crear una escena de realidad virtual utilizando el tag `<a-scene>`. Esta va a ser la etiqueta padre de nuestro
 Dentro de la escena, agregamos 5 elementos propios de A-Frame. Estos elementos, conocidos como Primitivas,
